...
?><?$APPLICATION->IncludeComponent("bitrix:news.list", "serviceBgForm", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"IBLOCK_TYPE" => "serviceBgTitleForm",	// Тип информационного блока (используется только для проверки)
	...
	false
);?>fsdfdfssdfsdfdsffdssdfdfsfdsfsdfsd<? require($_SERVER["DOCUMENT_ROOT"] . "/bitrix/footer.php"); ?>