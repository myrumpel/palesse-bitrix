...
; /* Start:"a:4:{s:4:"full";s:58:"/local/templates/palesse/assets/js/app.js?1687448155476698";s:6:"source";s:41:"/local/templates/palesse/assets/js/app.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
;(() => {
	'use strict'
	function isWebp() {
	...
	const inputsIndex = document.querySelectorAll('.feedback__input')(
		function () {
			inputsIndex.forEach(elm => {
				elm.addEventListener('focus', e => {
					const textLabel = e.target.nextElementSibling
...
/* End */
;; /* /local/templates/palesse/assets/js/app.js?1687448155476698*/
