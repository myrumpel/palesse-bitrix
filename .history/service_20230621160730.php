...
<section class="service">
							...
							<div class="service__inner">
								<div class="service__main">
									...
									<div class="service__main-bg-box">
										<div class="service__main-bg-two" style='background-image: url(img/pages-bg-pictures/services-main-two.jpg);'>

										</div>
										<div class="service__main-bg-one" style='background-image: url(img/pages-bg-pictures/services-main-one.jpg);'>
						...
						<section class="about-leaders service-trust">
							...
							<div class="container-fluid">
								<div class="about-leaders__bg service-trust__bg" style='background-image: url(img/pages-bg-pictures/services-wheat.jpg);'>
									<div class="container">
