...
?>
                ...
                <section class="main-part">
                    <div class="container-fluid">
                        <div class="main-part__bg" style='background-image: url(<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pictures/index-main.jpg);'>
                            <div class="container">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <article class="swiper-slide local-index" data-slider='combains-cereal'>
                                                    <a href='/catalog.html'>
                                                        ...
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/combains.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider='tractors-mtz'>
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Тракторы</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/tractors.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider='sprayers-self'>
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Опрыскиватели</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/opriskivateli.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="seeders-tilled">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Сеялки</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/seyalki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="reapers">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Жатки</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/zhatki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="mulcher">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Мульчеры</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/mulcher.jpeg' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="mowers">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Косилки</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/cosilki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="loaders">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Погрузчики</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/pogruzchiki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="cultivators-cult">
                                                    <a href='/catalog.html'>
                                                        ...
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/pochvo-tech.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="spreaders">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Навозо-
                                                            разбрасыватели</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/navozo-razbrasivateli.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="feeders">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Кормораздатчики</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/kormorazdatchiki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="balers">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Пресс-подборщики</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/press-sborshiki.png' alt='slide'>
                                                    </a>
                                                </article>
                                                <article class="swiper-slide local-index" data-slider="trailers">
                                                    <a href='/catalog.html'>
                                                        <h5 class='swiper-slide__title'>Прицепы</h5>
                                                        <img class='swiper-slide__img' src='<?=SITE_TEMPLATE_PATH;?>/assets/img/index-slider/pricepi.png' alt='slide'>
                                                    </a>
                                                </article>
                                            </div>
                                    ...
                                    <div class="index-swiper-nav__keeper">
                                        <div class="swiper-button-prev swiper-button__prev">
                                            <svg class='index-swiper-arrow-keeper index-swiper-arrow-keeper-left'>
                                                <use class='index-swiper-arrows index-swiper-arrow-prev' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-arrow-right'></use>
                                            </svg>
                                        </div>
                                        <div class="swiper-button-next swiper-button__next">
                                            <svg class='index-swiper-arrow-keeper index-swiper-arrow-keeper-right'>
                                                <use class='index-swiper-arrows index-swiper-arrow-next' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-arrow-right'></use>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="how-buy__title-link">
                            ...
                            <a class='how-buy__link' href='/ways.html'>
                                ...
                                <svg class='how-buy-arrow-keeper'>
                                    <use class='how-buy-arrow' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-arrow-right'></use>
                                </svg>
                            </a>
                        </div>
                ...
                <section class="index-about">
                    <div class="container-fluid">
                        <div class="index-about__bg" style='background-image: url(<?=SITE_TEMPLATE_PATH;?>/assets/<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pictures/index-second.jpg);'>
                            <div class="container">
                        ...
                        <ul class="benefit__list">
                            <li class="benefit__item">
                                <a class='benefit__item-link' href='/ways.html'>
                                    ...
                                    <svg class='benefit-keeper-arrow'>
                                        <use class='benefit-svg-arrow' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-arrow-right'></use>
                                    </svg>
                            ...
                            <li class="benefit__item">
                                <a class='benefit__item-link' href='/service.html'>
                                    <svg class='benefit-keeper-svg'>
                                        <use class='benefit-svg' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-guara'></use>
                                    </svg>
                            ...
                            <li class="benefit__item">
                                <a class='benefit__item-link' href='/spare-parts.html'>
                                    <svg class='benefit-keeper-svg'>
                                        <use class='benefit-svg' xlink:href='<?=SITE_TEMPLATE_PATH;?>/assets/img/icons/icons.svg#svg-service'></use>
                                    </svg>
