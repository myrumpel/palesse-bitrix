							...
							<div class="detail__inner">
								...
								<div class="detail__content">
									...
									<div class="detail__photo">
										<picture><source srcset="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pitures/about-main.webp" type="image/webp"><img src="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pitures/about-main.jpg" /></picture>
									</div>
										...
										<div class="swiper mySwiper2">
											<div class="swiper-wrapper">
												<div class="swiper-slide swiper-slide-detail">
													<picture><source srcset="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pictures/about-main.webp" type="image/webp"><img src="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pitures/about-main.jpg" /></picture>
												</div>
												<div class="swiper-slide swiper-slide-detail">
													<picture><source srcset="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pitures/about-main.webp" type="image/webp"><img src="<?=SITE_TEMPLATE_PATH;?>/assets/img/pages-bg-pitures/about-main.jpg" /></picture>
												</div>
