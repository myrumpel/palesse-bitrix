		...
		<h1 class='contacts__title'>
			<? $APPLICATION->IncludeComponent(
				...
				array(
					...
					"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsMainTitle.php"
				)
			); ?>
		</h1>
		<section class="contacts-accordion">
			<article class="contacts-accordion__item">
				<button class="contacts-accordion__btn">
					<? $APPLICATION->IncludeComponent(
						"bitrix:main.include",
						"",
						array(
							"AREA_FILE_SHOW" => "file",
							"AREA_FILE_SUFFIX" => "index",
							"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerComplete.php"
						)
					); ?>
						...
						<div class="district">
							<div class="district__title">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleCompleteKrasnodar.php"
									)
								); ?>
							...
							<? $APPLICATION->IncludeComponent(
								...
								array(
									...
									"PARENT_SECTION_CODE" => "",
									"PREVIEW_TRUNCATE_LEN" => "",
									"PROPERTY_CODE" => array("contactsNameLittle", "contactsNumberHref", "contactsLastNameLittle", ""),
									"SET_BROWSER_TITLE" => "N",
									"SET_LAST_MODIFIED" => "N",
									"SET_META_DESCRIPTION" => "N",
									"SET_META_KEYWORDS" => "N",
							...
							<div class="district__title fz-20">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleCompleteLnrDnr.php"
									)
								); ?>
							...
							<div class="district__title fz-20">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleCompleteSKFO.php"
									)
								); ?>
							...
							<div class="district__title fz-20">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleCompleteStavropol.php"
									)
								); ?>
							</div>
							<? $APPLICATION->IncludeComponent(
				...
				<button class="contacts-accordion__btn">
					<? $APPLICATION->IncludeComponent(
						...
						array(
							"AREA_FILE_SHOW" => "file",
							"AREA_FILE_SUFFIX" => "index",
							"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerSpare.php"
						)
					); ?>
					<p class='accordion-cross'>
						<span class='accordion-cross__line '></span>
						...
						<div class="district">
							<div class="district__title  fz-20">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleSpareStavropol.php"
									)
								); ?>
							...
							<? $APPLICATION->IncludeComponent(
								...
								array(
									...
									"SORT_ORDER2" => "",
									"STRICT_SECTION_CHECK" => "Y",
									"COMPONENT_TEMPLATE" => "contactsSpareStavropolSKFO"
								),
								false
							); ?>
						</div>
				...
				<button class="contacts-accordion__btn">
					<? $APPLICATION->IncludeComponent(
						...
						array(
							"AREA_FILE_SHOW" => "file",
							"AREA_FILE_SUFFIX" => "index",
							"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsSpollerService.php"
						)
					); ?>
					<p class='accordion-cross'>
						<span class='accordion-cross__line '></span>
