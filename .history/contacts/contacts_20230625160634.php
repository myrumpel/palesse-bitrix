							...
							<div class="map__right-content">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										...
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsAdress/contactsEmail.php"
									)
								); ?>
							</div>
						</div>
							...
							<div class="map__right-content map-item">
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsAdress/contactsAdress.php"
									)
								); ?>
							</div>
						</div>
							...
							<div class="map__right-content map-item">
								...
								<? $APPLICATION->IncludeComponent(
									...
									array(
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "index",
										"PATH" => SITE_TEMPLATE_PATH . "/contactsIncludes/contactsAdress/contactsSchedule.php"
									)
								); ?>
							</div>
						</div>
