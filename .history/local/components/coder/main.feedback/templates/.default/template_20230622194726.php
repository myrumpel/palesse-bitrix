					...
					<div class="feedback__content">
						<form action="<?= POST_FORM_ACTION_URI ?>" method="POST" class="feedback__form" id='feedback-form'>
							...
							'>
								...
								<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите ваше имя' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите ваше имя' ||
								$arResult["ERROR_MESSAGE"][2] === 'Укажите ваше имя' ) { ?> red-placeholder 
									<? 
									}?>
								" maxlength='40' id='feedback-name' 

								<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите ваше имя' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите ваше имя' ||
								$arResult["ERROR_MESSAGE"][2] === 'Укажите ваше имя' ) { ?> 
							...
							<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите номер телефона' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите номер телефона' ||
								$arResult["ERROR_MESSAGE"][2] === 'Укажите номер телефона' ) { ?> red-placeholder 
									<? 
									}?>
							'>
								<input class="feedback__input feedback__phone input-field-index" id='feedback-phone' type="tel" type="text" name='Phone'
								<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите номер телефона' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите номер телефона' ||
							...
							<label for='feedback-topic' class='feedback-label form-item'>
								...
								<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите тему обращения (от 8 символов)' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите тему обращения (от 8 символов)' ||
								$arResult["ERROR_MESSAGE"][2] === 'Укажите тему обращения (от 8 символов)' ) { ?> red-placeholder 
									<? 
									}?>
								" maxlength='80' id='feedback-topic' 
								<? if ($arResult["ERROR_MESSAGE"][0] === 'Укажите тему обращения (от 8 символов)' ||
								$arResult["ERROR_MESSAGE"][1] === 'Укажите тему обращения (от 8 символов)' ||
								$arResult["ERROR_MESSAGE"][2] === 'Укажите тему обращения (от 8 символов)' ) { ?> 
									style="border: 1px solid #de4545;"
									class='red-placeholder' 
									placeholder='Укажите тему обращения (от 8 символов)'
