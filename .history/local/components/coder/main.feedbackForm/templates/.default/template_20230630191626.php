...
<section class="feedback-tech">
	<div class="feedback-container container">
		<div class="feedback-container_target">
			...
			<div class="feedback__content  form-mobile-size-content flex-direction-column">
				<form class="feedback__form feedback-tech__form" action="<?= POST_FORM_ACTION_URI ?>" method="POST"
					...
					<label for='feedback-name' class='feedback-label service-fomr-item'>
						<input class="feedback__input feedback__name input-field-index<? if (
							...
							name='service_name' placeholder='Имя'>
					</label>
					...
					<label for='feedback-phone' class='feedback-label service-fomr-item'>
						<input class="feedback__input feedback__phone input-field-index <? if (
							$arResult["ERROR_MESSAGE"][0] === 'Укажите телефон' ||
							$arResult["ERROR_MESSAGE"][1] === 'Укажите телефон' ||
							$arResult["ERROR_MESSAGE"][2] === 'Укажите телефон' ||
							$arResult["ERROR_MESSAGE"][3] === 'Укажите телефон'
						) { ?> red-placeholder 
									<?
						 	...
						 	$arResult["ERROR_MESSAGE"][1] === 'Укажите телефон' ||
						 	$arResult["ERROR_MESSAGE"][2] === 'Укажите телефон'
						 ) { ?> style="border: 1px solid #de4545;" placeholder='Укажите телефон' <?
						 } else { ?>
					...
					<label for='tech-work' class='feedback-label service-fomr-item'>
						<input class="feedback__input input-field-index <? if (
							$arResult["ERROR_MESSAGE"][0] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][1] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][2] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][3] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][4] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][5] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][6] === 'Укажите работы' ||
							$arResult["ERROR_MESSAGE"][7] === 'Укажите работы'
						) { ?> red-placeholder 
									<?
						 	...
						 	$arResult["ERROR_MESSAGE"][6] === 'Укажите работы' ||
						 	$arResult["ERROR_MESSAGE"][7] === 'Укажите работы'
						 ) { ?> style="border: 1px solid #de4545;" placeholder='Укажите работы' <?
						 } else { ?>
							style="border: 1px solid #4a4f59" <? } ?> placeholder='Требуемые работы'>
					</label>
