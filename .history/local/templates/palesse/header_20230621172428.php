...
?>
        ...
        <body>
            ...
            <div class="wrapper">
                ...
                $APPLICATION->GetCurPage(false) === '/about.php' ||
                $APPLICATION->GetCurPage(false) === '/catalog.php' ||
                $APPLICATION->GetCurPage(false) === '/service.php'  ||
                $APPLICATION->GetCurPage(false) === '/spare-parts.php'||
                $APPLICATION->GetCurPage(false) === '/ways.php' 
                ): ?>
                                    <div class="site">
                                        <? endif; ?>
<!--            
