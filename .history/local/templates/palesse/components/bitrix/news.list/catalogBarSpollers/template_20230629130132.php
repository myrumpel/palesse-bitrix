	...
	<? if ($arResult['ITEMS']): ?>
		<? foreach ($arResult['ITEMS'] as $Item): ?>
			...
			<li class="catalog-filter__buttons-item">
				...
				<? foreach ($Item['DISPLAY_PROPERTIES'] as $Props => $Prop): ?>
					<?
					echo '<pre>';
					print_r($Prop);
					echo '</pre>';
					...
					<div class="catalog-filter__spoller" style='height: 100%;'>
						...
						<? foreach ($Prop['VALUE'] as $PropItem): ?>
							<ol class="catalog-filter__spoller-content">
								<li class="catalog-filter__spoller-item">
									<button class="catalog-filter__buttons-item-btn" data-catalog="
									<?= $Item['DISPLAY_PROPERTIES']['catalogBarSpollers']['DESCRIPTION']; ?>">
