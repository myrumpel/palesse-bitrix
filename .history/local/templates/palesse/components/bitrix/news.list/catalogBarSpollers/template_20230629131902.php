	...
	<? if ($arResult['ITEMS']): ?>
		<? foreach ($arResult['ITEMS'] as $Item): ?>
			...
			<li class="catalog-filter__buttons-item">
				...
				<!-- <? foreach ($Item['DISPLAY_PROPERTIES']['catalogBarSpollersData']['VALUE'] as $SpollerName): ?> -->


				<? foreach ($Item['DISPLAY_PROPERTIES'] as $Props): ?>
					<div class="catalog-filter__spoller " style='height: 100%'>
						<ol class="catalog-filter__spoller-content">
							<li class="catalog-filter__spoller-item">
								<button class="catalog-filter__buttons-item-btn" data-catalog="<?= $Props['catalogBarSpollersData']['VALUE']; ?>">
									<?= $SpollerName; ?>
								</button>
							</li>
