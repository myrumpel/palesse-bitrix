		...
		<div class="district__title fz-20">
			...
			<? $APPLICATION->IncludeComponent(
				...
				array(
					...
					"PATH" => SITE_TEMPLATE_PATH . "/local/templates/palesse/contactsIncludes/contactsSpollerTitles/contactsSpollerTitleCompleteKrasnodar.php"
					//contactsIncludes/contactsSpollerTitles/contactsSpollerTitleSpareKrasnodar.php
				)
			); ?>
