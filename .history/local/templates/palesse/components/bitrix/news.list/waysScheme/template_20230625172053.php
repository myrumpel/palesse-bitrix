			...
			<? foreach ($arResult['ITEMS'] as $Item): ?>
				<article class="scheme__item">
					...
					<ol class="scheme__item-props">
						<? foreach ($arResult['ITEMS']['PROPERTIES']['waysSchemeProps']['VALUE'] as $Prop): ?>
					...
					<div class="scheme__item-content">
						<p class="scheme__item-text">
							Предлагает предприятиям АПК ниверсальные лизинговые решения для обновления парка техники.
						</p>
						<p class="scheme__item-text">
