		...
		<div class="container-fluid">
			<? foreach ($arResult['ITEMS'] as $Item): ?>
				<div class="about-leaders__bg" style='background-image: url(									<?= $Item['PREVIEW_PICTURE']['SRC']; ?>
							...
							<div class="about-leaders__content">
								...
								<div class="about-leaders__content-text">
									...
									<p class=''><span>711
										...
										при обновлении комбайнового парка,
									</p>
									<p class=''><span>685
											<?= $Item["PROPERTIES"]["aboutLeadersNumber2"]["VALUE"]; ?>

										</span>
										сельхозтоваропроизводителей при приобретении
										тракторов, более
									...
									<p class=''><span>815
										...
										сельхозпроизводителей, приобретавших прочую технику.
					...
					<?
					echo '<pre>';
					print_r($Item["PROPERTIES"]["aboutLeadersSubtitle"]["VALUE"]);
					echo '</pre>';
					?>
				<? endforeach; ?>
			</div>
