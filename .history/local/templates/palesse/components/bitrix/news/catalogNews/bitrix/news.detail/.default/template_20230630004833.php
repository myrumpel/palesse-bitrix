							...
							<li class="detail-content__item" id='buy'>
								<div class="spoller-content" data-mobdetail='buy'>
									<ol class='detail-content__list'>
										...
										echo '</pre>';
										?>
										<? if ($arResult['PROPERTIES']['rosagrolizing']['NAME']): ?>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['rosagrolizing']['NAME'] === 'Льготный кредит'): ?>
											<li class="detail-content__list-item">
												<div class="detail-content__list-item-img">
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['rosagrolizing']['NAME'] === 'Коммерческий лизинг'): ?>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['rosagrolizing']['NAME'] === 'Собственные средства'): ?>
