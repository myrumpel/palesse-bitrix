				...
				<div class="detail__content">
					...
					<? if ($arResult['DISPLAY_PROPERTIES']['catalogDetailPictureWEBP']['FILE_VALUE'] == 1): ?>
						<div class="detail__photo">
							<picture>
								<source srcset="<?= $arResult['DISPLAY_PROPERTIES']['catalogDetailPictureWEBP']['FILE_VALUE']['SRC']; ?>"
									type="image/webp"><img
									src="<?= $arResult['DISPLAY_PROPERTIES']['catalogDetailPictureJPG']['FILE_VALUE']['SRC']; ?>" />
							</picture>
						</div>
					<? endif; ?>
					<!-- [FILE_VALUE] -->
					...
					<div class="detail__slider">
						<div class="swiper mySwiper2">
							<div class="swiper-wrapper">
								<? if ($arResult['DISPLAY_PROPERTIES']['catalogDetailPictureWEBP'] >= 1): ?>
										...
										<tr class='table-headline__row'>
											...
											<td class='table-headline__td table-headline__td-second'>
												<ol class='table-headline__td-list'>
													...
													<li class='table-headline__td-item' style='margin-left: -2px'>
														-
														<span style='display: inline-block; margin-left: 17px'>недоступно</span>
													</li>
												</ol>
											</td>
										</tr>
							...
							<li class="detail-content__item" id='buy'>
								<div class="spoller-content" data-mobdetail='buy'>
									<ol class='detail-content__list'>
										...
										<? if ($arResult['PROPERTIES']['rosagrolizing']['VALUE'] === '+'): ?>
											<li class="detail-content__list-item">
												...
												<div class="detail-content__list-item-content">
													...
													<div class="detail-content__list-item-props">
														<? foreach ($arResult['PROPERTIES']['rosagrolizingProps']['VALUE'] as $Prop): ?>
															<p class='detail-content__list-item-prop'>
																<?= $Prop ? $Prop : ''; ?>
															</p>
														<? endforeach; ?>

													</div>
													<div class="detail-content__list-item-text">
														<?= $arResult['PROPERTIES']['rosagrolizingDesc']['VALUE'] ? $arResult['PROPERTIES']['rosagrolizingDesc']['VALUE'] : ''; ?>
													</div>
												</div>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['credit']['VALUE'] === '+'): ?>
											<li class="detail-content__list-item">
												<div class="detail-content__list-item-img">
												...
												<div class="detail-content__list-item-content">
													...
													<div class="detail-content__list-item-props">
														<? foreach ($arResult['PROPERTIES']['creditProps']['VALUE'] as $Prop): ?>
															<p class='detail-content__list-item-prop'>
																<?= $Prop ? $Prop : ''; ?>
															</p>
														<? endforeach; ?>
													...
													<div class="detail-content__list-item-text">
														<?= $arResult['PROPERTIES']['creditDesc']['VALUE'] ? $arResult['PROPERTIES']['creditDesc']['VALUE'] : ''; ?>
													</div>
												</div>
												<a class='detail-link-to-form' href='#feedback'>Нужна помощь с выбором</a>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['commlizing']['VALUE'] === '+'): ?>
											...
											<li class="detail-content__list-item">
												...
												<div class="detail-content__list-item-content">
													...
													<div class="detail-content__list-item-props">
														<? foreach ($arResult['PROPERTIES']['commlizingProps']['VALUE'] as $Prop): ?>
															<p class='detail-content__list-item-prop'>
																<?= $Prop ? $Prop : ''; ?>
															</p>
														<? endforeach; ?>
													...
													<div class="detail-content__list-item-text">
														<?= $arResult['PROPERTIES']['commlizingDesc']['VALUE'] ? $arResult['PROPERTIES']['commlizingDesc']['VALUE'] : ''; ?>
													</div>
												</div>
												<a class='detail-link-to-form' href='#feedback'>Нужна помощь с выбором</a>
										...
										<? if ($arResult['PROPERTIES']['cash']['VALUE'] === '+'): ?>
											...
											<li class="detail-content__list-item">
												...
												<div class="detail-content__list-item-content">
													...
													<div class="detail-content__list-item-props">
														<? foreach ($arResult['PROPERTIES']['cashProps']['VALUE'] as $Prop): ?>
															<p class='detail-content__list-item-prop'>
																<?= $Prop ? $Prop : ''; ?>
															</p>
														<? endforeach; ?>
													...
													<div class="detail-content__list-item-text">
														<?= $arResult['PROPERTIES']['cashDesc']['VALUE'] ? $arResult['PROPERTIES']['cashDesc']['VALUE'] : ''; ?>
													</div>
												</div>
												<a class='detail-link-to-form' href='#feedback'>Нужна помощь с выбором</a>
