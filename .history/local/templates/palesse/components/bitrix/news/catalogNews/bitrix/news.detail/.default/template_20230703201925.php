			...
			<div class="detail__inner">
				...
				<div class="detail__content">
					...
					<div class="detail__photo">
						<picture>
							<source srcset="<?= $arResult['DISPLAY_PROPERTIES']['catalogDetailPictureWEBP']['FILE_VALUE']['SRC'][0]; ?>"
								type="image/webp"><img
								src="<?= $arResult['DISPLAY_PROPERTIES']['catalogDetailPictureJPG']['FILE_VALUE']['SRC'][0]; ?>" />
						</picture>
					</div>
