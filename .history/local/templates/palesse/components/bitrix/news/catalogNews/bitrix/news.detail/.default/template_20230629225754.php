...
<?
echo '<pre>';
print_r($arResult['DISPLAY_PROPERTIES']['catalogDetailShortDescription']['DISPLAY_VALUE']);
echo '</pre>';
?>
<? if ($arResult): ?>
	<div class="detail">
				...
				<div class="detail__content">
					<div class="detail-box">
						<div class="detail__desc">
							...
							<? foreach ($arResult['DISPLAY_PROPERTIES']['catalogDetailShortDescription']['DISPLAY_VALUE'] as $PropVal): ?>
