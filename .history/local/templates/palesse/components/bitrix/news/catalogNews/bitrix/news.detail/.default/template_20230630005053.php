							...
							<li class="detail-content__item" id='buy'>
								<div class="spoller-content" data-mobdetail='buy'>
									<ol class='detail-content__list'>
										...
										<?
										echo '<pre>';
										print_r($arResult['PROPERTIES']['credit']['NAME']);
										echo '</pre>';
										?>
										<? if ($arResult['PROPERTIES']['rosagrolizing']['NAME'] === 'Росагролизинг'): ?>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['credit']['NAME'] === 'Льготный кредит'): ?>
											<li class="detail-content__list-item">
												<div class="detail-content__list-item-img">
													<img src='<?= SITE_TEMPLATE_PATH; ?>/assets/img/methods/credit.png' alt=''>
												</div>
												<div class="detail-content__list-item-content">
													<div class="detail-content__list-item-title">Льготный кредит</div>
													<div class="detail-content__list-item-props">
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['commlizing']['NAME'] === 'Коммерческий лизинг'): ?>
										...
										<? endif; ?>
										<? if ($arResult['PROPERTIES']['cash']['NAME'] === 'Собственные средства'): ?>
