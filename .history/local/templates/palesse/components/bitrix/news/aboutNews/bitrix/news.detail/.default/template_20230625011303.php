...
<?
echo '<pre>';
print_r($arResult['DISPLAY_PROPERTIES']['aboutNewsDetailVideo']['FILE_VALUE']);
echo '</pre>';
// ?> -->
<? if (!empty($arResult)): ?>
		...
		<div class="container">
			<div class="news-detail__inner">
				...
				<div class=" news-detail__content">
					<? foreach ($arResult['DISPLAY_PROPERTIES']['aboutNewsDetailVideo']['FILE_VALUE'] as $Vid): ?> <iframe
						width="560" height="315" src="<?= $Vid['VALUE']; ?>" title="YouTube video player" frameborder="0"
