			...
			<div class="news-detail__inner">
				<ol class="breadcrumbs">
					<li class="breadcrumbs__item">
						<a href="http://palesse:8888/about/main.php" class="breadcrumbs__link">О компании /</a>
					</li>
				...
				<div class=" news-detail__content">
					<? foreach ($arResult['DISPLAY_PROPERTIES']['aboutNewsDetailVideo']['VALUE'] as $Vid): ?> <iframe
						class='margin-top-bottom-3' width="560" height="315" src="<?= $Vid; ?>" title="YouTube video player"
						frameborder="0"
