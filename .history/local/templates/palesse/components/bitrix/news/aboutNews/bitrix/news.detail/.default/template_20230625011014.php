...
<?
echo '<pre>';
print_r($arResult['DISPLAY_PROPERTIES']['aboutNewsDetailPictures']['FILE_VALUE']);
echo '</pre>';
?>
<? if (!empty($arResult)): ?>
		...
		<div class="container">
			<div class="news-detail__inner">
				...
				<div class=" news-detail__content">
					<!-- <? foreach ($arResult['PROPERTIES']['aboutNewsDetailVideo'] as $Video): ?>
			...
			<? endforeach; ?> -->
					<? foreach ($arResult['FIELDS'] as $Pic): ?>


						<img src='<?= $Pic['PREVIEW_PICTURE']['SRC']; ?>' alt=''>
					<? endforeach; ?>
				</div>
			</div>
		</div>
