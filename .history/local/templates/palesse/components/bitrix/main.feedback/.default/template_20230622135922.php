							...
							<form class="feedback__form" id="feedback-form" action="<?= POST_FORM_ACTION_URI ?>" method="POST">
								...
								<label for="feedback-name" class="feedback-label form-item">
									<input class="feedback__input feedback__name input-field-index" maxlength="40" id="feedback-name"
										type="text" name="user_name" value="<?= $arResult["AUTHOR_NAME"] ?>"> <span
										class="label-span">Имя</span> </label> <label for="feedback-phone" class="feedback-label form-item">
									<input class="feedback__input feedback__phone input-field-index" id="feedback-phone" type="tel"
										name="user_email" value="<?= $arResult["AUTHOR_EMAIL"] ?>" maxlength="20"> <span class="label-span">
										Телефон</span>
										...
										type="text" type="submit" name="submit" value="<?= GetMessage("MFT_SUBMIT") ?>"><?= $arResult["MESSAGE"] ?> <span class="label-span">Тема сообщения</span> </label> <button
