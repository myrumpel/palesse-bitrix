				...
				<div class="container">
					<div class="feedback__inner">
						<div class="feedback__content">
							<form class="feedback__form" id="feedback-form" action="<?= POST_FORM_ACTION_URI ?>" method="POST">
								<?= bitrix_sessid_post() ?>
								...
								<label for="feedback-name" class="feedback-label form-item"> <input
										...
										type="text" name="Name" value="<?= $arResult["AUTHOR_NAME"] ?>"> <span class="label-span">Имя</span>
								</label> <label for="feedback-phone" class="feedback-label form-item"> <input
										class="feedback__input feedback__phone input-field-index" id="feedback-phone" type="tel"
										name="Phone" maxlength="20"> <span class="label-span" value="<?= $arResult["AUTHOR_EMAIL"] ?>">
										Телефон</span>
										...
										type="text" name="Topic" <?= $arResult["MESSAGE"] ?>> <span class="label-span">Тема сообщения</span>
								</label> <button class="red-button-link feedback__btn form-item" type="submit" name="submit">Отправить
									заявку</button>
