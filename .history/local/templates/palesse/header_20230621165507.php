...
?>
        ...
        <body>
            ...
            <div class="wrapper">
                ...
                <?php if($APPLICATION->GetCurDir() !== '/contacts.php' || $APPLICATION->GetCurDir() !== '/news-detail.php' || $APPLICATION->GetCurDir() !== '/catalog-detail.php' )?>

                <? if ($APPLICATION->GetCurPage(false) === '/contacts.php' || 
                $APPLICATION->GetCurPage(false) === '/news-detail.php'
                || 
                $APPLICATION->GetCurPage(false) === '/catalog-detail.php'
                ): ?>
