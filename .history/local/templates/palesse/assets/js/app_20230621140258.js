...
*/
    ...
    (function() {
        if (document.querySelector(".about-leaders__content")) {
            ...
            if (window.innerWidth < 951) aboutMobContainer.insertAdjacentElement("afterbegin", aboutPageContent); else parent.insertAdjacentElement("afterbegin", aboutPageContent);
    ...
    (function() {
        if (document.querySelector(".index-about__content")) {
            ...
            const aboutNumbersInner = document.querySelector(".index-about-numbers__inner");
            const parent = aboutContent.parentNode;
            if (window.innerWidth < 618) aboutNumbersInner.insertAdjacentElement("beforebegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            window.addEventListener("resize", (evt => {
                if (window.innerWidth < 618) aboutNumbersInner.insertAdjacentElement("beforebegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            }));
        }
    ...
    (function() {
        if (document.querySelector(".feedback")) {
            ...
            const feedbackTarget = document.querySelector(".feedback-container_target");
            const parentFeedbackContent = feedbackContent.parentNode;
            if (window.innerWidth < 625) feedbackTarget.insertAdjacentElement("afterbegin", feedbackContent);
            window.addEventListener("resize", (evt => {
                if (window.innerWidth < 625) feedbackTarget.insertAdjacentElement("afterbegin", feedbackContent); else parentFeedbackContent.insertAdjacentElement("afterbegin", feedbackContent);
            }));
        }
    })();
    (function() {
    ...
    (function() {
        if (document.querySelector(".feedback-tech__title")) {
            ...
            const parent = aboutContent.parentNode;
            if (window.innerWidth < 960) aboutNumbersInner.insertAdjacentElement("beforebegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            window.addEventListener("resize", (evt => {
                if (window.innerWidth < 960) aboutNumbersInner.insertAdjacentElement("beforebegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            }));
        }
    ...
    (function() {
        if (document.querySelector(".service-trust__content")) {
            ...
            const parent = aboutContent.parentNode;
            if (window.innerWidth < 701) aboutNumbersInner.insertAdjacentElement("afterbegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            window.addEventListener("resize", (evt => {
                if (window.innerWidth < 701) aboutNumbersInner.insertAdjacentElement("afterbegin", aboutContent); else parent.insertAdjacentElement("afterbegin", aboutContent);
            }));
        }
    ...
    (function() {
        if (document.querySelector(".ways__face-title")) {
            ...
            if (window.innerWidth < 1020) waysLine.insertAdjacentElement("beforebegin", waysTitle); else parent.insertAdjacentElement("afterbegin", waysTitle);
            window.addEventListener("resize", (evt => {
                if (window.innerWidth < 1020) waysLine.insertAdjacentElement("beforebegin", waysTitle); else parent.insertAdjacentElement("afterbegin", waysTitle);
            }));
        }
...
*/    var ScrollToPlugin_gsap, ScrollToPlugin_coreInitted, _window, ScrollToPlugin_docEl, ScrollToPlugin_body, ScrollToPlugin_toArray, ScrollToPlugin_config, ScrollToPlugin_ScrollTrigger, ScrollToPlugin_windowExists = function _windowExists() {
    ...
    (function() {
        ...
        selectMobBtn.forEach((elm => {
            elm.addEventListener("click", (evt => {
                ...
                if (clickTarget.classList.contains("select-mob__btn")) {
                    const btn = clickTarget.closest(".select-mob__list").previousElementSibling;
        ...
        if (document.querySelector(".select-mob")) selectMob.addEventListener("touchstart", (evt => {
    ...
    const showAnim = gsapWithCSS.from(".header", {
        yPercent: -200,
        paused: true,
        duration: .2
    }).progress(1);
    ScrollTrigger_ScrollTrigger.create({
        ...
        onUpdate: self => {
            ...
            const selectMob = document.querySelector(".select-mob");
            const selectMobList = document.querySelector(".select-mob__list");
            if (self.direction === -1) showAnim.play(); else {
    ...
    window.addEventListener("scroll", (e => {
        if (window.scrollY < 50) document.querySelector(".header").style.backgroundColor = "transparent"; else document.querySelector(".header").style.backgroundColor = "#f1f4ff";
    }));
    ...
    headerFixDetail();
    const showSideBar = gsapWithCSS.from(".catalog-filter__buttons", {
        paused: true,
        duration: .2
    }).progress(1);
    ScrollTrigger_ScrollTrigger.create({
    ...
    btnMenu.addEventListener("touchstart", (evt => {
        ...
        if (!isOpend) {
            ...
            gsapWithCSS.to(header, .2, {
                backgroundColor: ""
            });
            noneScroll(visible);
            mobileMenuBtnClose();
            if (!header.classList.contains("headerShow")) gsapWithCSS.to(header, .2, {
                backgroundColor: "#f1f4ff"
            });
            gsapWithCSS.to(mobileMenu, .2, {
                autoAlpha: 0
            }, "-=.2");
            isOpend = false;
        }
    ...
    const mobileMenuItems = () => {
        tlMobileMenu.to(header, .2, {
            ...
            y: "0",
            autoAlpha: 1
        }, "-=.2").fromTo(".mobile-menu__item", {
            autoAlpha: 0,
            stagger: .05
        }, {
            autoAlpha: 1,
            stagger: .05
        }).fromTo(".mobile-menu__phone-keeper", {
            autoAlpha: 0,
            stagger: .05
        }, {
            autoAlpha: 1,
            stagger: .05
        }, "-=.4").fromTo(".mobile-menu__copy", {
            autoAlpha: 0,
            stagger: .05
        }, {
            autoAlpha: 1,
    ...
    window.addEventListener("load", (e => {
        ...
        if (document.querySelector(".main-part__title")) {
            TLindexMain.from(".main-part__title", {
                ...
                delay: .7,
                ease: Power4
            }).from(".main-part__subtitle", {
                autoAlpha: 0,
                x: -30,
                ease: Power4
            }, "-=.2").from(".main-part__leave-bid", {
                autoAlpha: 0,
                y: 30,
                ease: Power4
            }, "-=.2").from(".swiper-slide", 1.5, {
                autoAlpha: 0,
                x: "50%",
                ease: "elastic.out(3, 1)"
            }, "-=.2.5").from(".index-swiper-nav__keeper", {
                autoAlpha: 0,
                x: "50%",
                ease: Power4
            }, "-=2.5");
    ...
    (function() {
        ...
        const btnsBar = document.querySelectorAll(".catalog-filter__buttons-item-btn");
        const catalogContents = document.querySelectorAll(".catalog-filter__contents-item");
        const barSpollers = document.querySelectorAll(".catalog-filter__buttons-spoller");
        ...
        //! Start of workplace
            ...
            function clickListener(btns, btnClass) {
                btns.forEach((elm => {
                    elm.addEventListener("click", (evt => {
                        if (evt) if (document.documentElement.scrollTop > 300 && evt) window.scrollTo({
                            top: 0,
                            behavior: "instant"
                        });
                        refresh();
            ...
            function takeCurrentBtn(evt) {
                ...
                if (innWidth) displayDesktop(currentBtn); else displayMobile(currentBtn);
            }
            ...
            function startShowAndData(sortOfBtns, localItem) {
                if (localItem) {
                    if (innWidth) {
                        const localBtn = document.querySelector(`[data-catalog='${localItem}']`);
                        displayDesktop(localBtn);
                    } else {
                        const localBtn = document.querySelector(`[data-catalogmob='${localItem}']`);
                    ...
                    for (let i = 0; i < 1; i++) {
                        ...
                        if (innWidth) displayDesktop(element); else displayMobile(element);
                    }
                })();
            }
            //! WorkPlace
                        clickListener(innWidth ? btnsBar : btnsSpollerMob, innWidth ? btnActive : mobSpollerActive);
            barSpollerClick();
    ...
    if (document.querySelector(".detail")) {
        ...
        const mobContainerTitle = document.querySelectorAll(".detail-content-mob h2");
            ...
            if (type == on) {
                ...
                mobContainerTitle.forEach((elm => {
                    for (let i = contentItem.length - 1; i >= 0; i--) {
                        ...
                        if (element.dataset.mobdetail === elm.dataset.mobdetail) removeInsert(element, elm, "afterend");
                    }
                }));
            } else {
                ...
                mobContainerTitle.forEach((elm => {
                    for (let i = contentItem.length - 1; i >= 0; i--) {
                        ...
                        if (data === idElement.id) removeInsert(element, idElement, "beforeend");
                    }
                }));
            }
        }
    ...
    if (document.querySelector(".detail-box__title")) {
        const detailsSpollers = document.querySelectorAll(".detail-content__btn-spoller");
        const detailContents = document.querySelectorAll(".detail-content__item");
        (function() {
            detailsSpollers.forEach((elm => {
                elm.addEventListener("click", (evt => {
                    detailsSpollers.forEach((element => element.classList.remove("btn-spoller--active")));
                    detailContents.forEach((element => element.classList.remove("detail-item--active")));
                    const currentBtn = evt.currentTarget;
    ...
    if (document.querySelector(".feedback__form")) {
        ...
        const IndexFormFields = indexFormValidation.querySelectorAll(".input-field-index");
        indexFormValidation.addEventListener("submit", (evt => {
            evt.preventDefault();
            let isRight = true;
    ...
    if (mql.matches) portraitOrientation(); else horizontalOrientation();
    ...
    window.addEventListener("load", (e => {
        TLabout.from(".about__title", {
            ...
            autoAlpha: 0,
            ease: Power4
        }, "-=.3").from(".about-leaders__bg", {
            autoAlpha: 0,
            y: 50,
            ease: Power4
        }, "-=.3").from(".about-leaders__content", {
            autoAlpha: 0,
            y: 150,
            ease: Power4
        }, "-=.1");
    ...
    window.addEventListener("load", (e => {
        TLservice.from(".service__headline-title", {
            ...
            ease: Power4,
            delay: 1
        }).from(".service__headline-subtitle", {
            y: 50,
            autoAlpha: 0,
            ease: Power4
        }, "-=.3").from(".service-btn", {
            ...
            y: 50,
            ease: Power4
        }, "-=.3").from(".service__main-bg-one", {
            autoAlpha: 0,
            x: 150,
            ease: Power4
        }, "-=.1").from(".service__main-bg-two", {
            autoAlpha: 0,
            x: -150,
            ease: Power4
        }, "-=.5");
    ...
    window.addEventListener("load", (e => {
        TLways.from(".ways__face-title", {
            ...
            ease: Power4,
            delay: 1
        }).from(".ways__face-photo", {
            y: 50,
            autoAlpha: 0,
            ease: Power4
        }, "-=.2").from(".ways__face-list", {
            autoAlpha: 0,
            delay: .2,
            height: 0,
            ease: Power4
    ...
    if (document.querySelector(".map")) {
        ...
        window.addEventListener("resize", (evt => {
            if (window.innerWidth > 1100) {
                if (mapContainer.children.length < 1) mapContainer.insertAdjacentHTML("afterbegin", deskctopMap);
            } else if (mapMobileContainer.children.length < 1) mapMobileContainer.insertAdjacentHTML("afterbegin", mobileMap);
        }));
    }
    isWebp();
})();