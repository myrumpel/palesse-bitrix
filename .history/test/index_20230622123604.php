					...
					<div class="feedback__content">
						<form class="feedback__form" id="feedback-form">
							...
							<label for="feedback-name" class="feedback-label form-item"> <input
									class="feedback__input feedback__name input-field-index" maxlength="40" id="feedback-name" type="text"
									name="Name"> <span class="label-span">Имя</span> </label> <label for="feedback-phone"
...
<? $APPLICATION->IncludeComponent(
	"/Users/raketa/Documents/sites/palesse/local/templates/palesse/components/forms:main.feedback",
	"",
	array(
