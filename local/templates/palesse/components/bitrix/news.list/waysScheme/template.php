...
<? if (!empty($arResult['ITEMS'])): ?>
	...
	<section class="scheme" id="scheme">
		<h2 class="scheme__title">
			<? $APPLICATION->IncludeComponent(
				...
				array(
					...
					"PATH" => SITE_TEMPLATE_PATH . "/waysIncludes/waysSchemeTitle.php"
				)
			); ?>
		</h2>
		<div class="scheme__inner">
			...
			<? foreach ($arResult['ITEMS'] as $Item): ?>
				<article class="scheme__item">
					<img src="<?= $Item['PREVIEW_PICTURE']['SRC'] ? $Item['PREVIEW_PICTURE']['SRC'] : ''; ?>"
						class="scheme__item-photo" alt="">
		...
		<div class="scheme__center-link-keeper">
			<a class="scheme__center-link" href="#feedback">
				...
				<? $APPLICATION->IncludeComponent(
					...
					array(
						"AREA_FILE_SHOW" => "file",
						"AREA_FILE_SUFFIX" => "index",
						"PATH" => SITE_TEMPLATE_PATH . "/waysIncludes/waysSchemeBtn.php"
					)
				); ?>
			</a>
		</div>
